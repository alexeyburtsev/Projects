...
| Monitoring System | Problem Setup: - The Client has thousands of events produced by his monitoring system every day. Events are parsed and represented as strings. - The Client wants to have a daily report with events summary. Tickets data is for 1 day is provided in the form of a csv file. There is 1 column: "ticket", without an index. |
